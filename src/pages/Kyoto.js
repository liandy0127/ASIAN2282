...
const Kyoto = () => (
  <div className="city-page">
    ...
    <p> After Daniel's wedding in Singapore, we headed to Japan to visit Daniel’s wife Yumika’s family, and gonna spend New Year there.</p>
    ...
    <p>We settled down on tatami mats, and as the meal began—beautifully arranged plates, delicate flavors—our conversation turned to the changes the city had seen over the last few decades. Yumika’s parents admitted that with the rapid development of the real estate market, land prices had soared, and many traditional machiya were forced to sell or be demolished [17].</p>
    ...
    <p>Her mother added with a sigh, “Even so, high land prices and market forces still pose a threat to traditional culture. Many old restaurants and shops have closed because they can’t afford the rent.” [17]</p>
    ...
    <p>Jackie watched a botanical drone release a gentle nutrient mist over the saplings. “They didn’t just limit visitors; they revitalized the environment,” she observed. [21]</p>
    <p>Yumika pointed to a softly lit sign that directed visitors to a lesser-known shrine off the main path. “They also spread out the crowds. The city’s Destination Management Organization promoted smaller temples. Instead of everyone flooding Fushimi Inari or Kiyomizu-dera, people now discover places like Enkoji in the north—quiet, authentic, and relieving pressure on iconic sites.” [21]</p>
    ...
    <p>Inside the theater, a noh performance was underway. The actors’ deliberate movements were set against a backdrop of dynamic holographic projections depicting Kyoto’s changing seasons, creating an immersive atmosphere. Subtitles projected nearby ensured every audience member could follow the story [25].</p>
